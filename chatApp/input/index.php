    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
              ...
              <div class="container">
              <?php
                $fileData2 = file_get_contents('error.html');
                $fileData2 = explode("<hr>", $fileData2);
                $array2 = array_map('trim', $fileData2); // 各行にtrim()をかける
                $array2 = array_filter($array2, 'strlen'); // 文字数が0の行を取り除く
                $fileData2 = array_values($array2); // これはキーを連番に振りなおしてるだけ

                $cnt = count($fileData2);
                //for( $i=0;$i<$cnt;$i++ ){
                for ($i = $cnt - 1; $i >= 0; $i--) {
                    echo ("<div>" . $fileData2[$i] . "</div><hr>");
                }
                ?>
